                ...
                <div>
                    ...
                    <>
                        ...
                        <div className=' flex  flex-wrap gap-x-10 gap-6'>
                            <InputFild Label="First Name" palaceholder="First Name" />
                            <InputFild Label="First Name" palaceholder="First Name" />
                            <InputFild Label="First Name" palaceholder="First Name" />
                            <InputFild Label="First Name" palaceholder="First Name" />
                    ...
                    <>
                        ...
                        <div className=' flex  flex-wrap gap-x-10 gap-6'>
                            <InputFild Label="Address 1" palaceholder="Address 1" />
                            <InputFild Label="Address 2" palaceholder="Address 2" />
                            <InputFild Label="City" palaceholder="City" />
                            <InputFild Label="Post Code" palaceholder="Post Code" type="Number" />
                    ...
                    <>
                        <Title className="mt-[54px]" TiteleText="Your Personal Details " />
                        <div className=' flex  flex-wrap gap-x-10 gap-6'>
                            <InputFild Label="Password" palaceholder="Your Password" type="password" />
                            <InputFild Label="Repeat Password" palaceholder="Repeat Password" type="password" />
                        </div>
